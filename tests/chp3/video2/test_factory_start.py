"""Test the data_processor module """
...
def test_csv_reader_header_fields(process_data):
    ...
    assert header_fields == ["Country", "City", "State_Or_Province", "Lat", "Long", "Altitude"]
...
def test_csv_reader_malformed_data_contents(process_data):
    ...
    with pytest.raises(ValueError) as exp:
        data_processor.csv_reader(process_data(file_name_or_type="malformed_map.csv"))
